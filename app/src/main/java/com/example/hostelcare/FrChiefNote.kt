 ...
 * [FrChiefNote.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FrChiefNote.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class FrChiefNote : Fragment() {
    ...
    override fun onCreateView(
        ...
        var rootView: View?= inflater.inflate(R.layout.fragment_fr_chief_note, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment FrChiefNote.
         */
